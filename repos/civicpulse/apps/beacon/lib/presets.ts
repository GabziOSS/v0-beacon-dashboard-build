import type { ChartBlock } from '@beacon/dashboard'
...
export const PRESETS: Record<PresetId, Preset> = {
  overview: {
    ...
    blocks: [
      ...
      },
      {
        id: 'heat',
        title: 'Heat Matrix',
        subtitle: 'Incidents by type × day',
        colSpan: 2,
        rowSpan: 1,
        type: 'heatmap',
      },
      ...
      },
      {
        id: 'comp2',
        title: 'Risk Vector',
        subtitle: 'Primary threat bearing',
        colSpan: 1,
        rowSpan: 1,
        type: 'compass',
      },
  ...
  fire: {
    ...
    blocks: [
      ...
      },
      {
        id: 'f-type',
        title: 'By Fire Type',
        subtitle: 'Structure / Vegetation / Vehicle',
        colSpan: 1,
        rowSpan: 1,
        type: 'bar',
      },
      {
        id: 'f-zone',
        title: 'Fires by Zone',
        subtitle: 'District distribution',
        colSpan: 1,
        rowSpan: 1,
        type: 'bar',
      },
      ...
      {
        id: 'f-calendar',
        title: 'Annual Fire Log',
        subtitle: '2025 daily counts',
        colSpan: 3,
        rowSpan: 1,
        type: 'calendar',
      },
  ...
  flood: {
    ...
    blocks: [
      ...
      {
        id: 'fl-calendar',
        title: 'Annual Flood Log',
        subtitle: 'Events by day',
        colSpan: 3,
        rowSpan: 1,
        type: 'calendar',
      },
  ...
  crime: {
    ...
    blocks: [
      ...
      {
        id: 'c-calendar',
        title: 'Annual Crime Log',
        subtitle: 'Daily incidents',
        colSpan: 3,
        rowSpan: 1,
        type: 'calendar',
      },
  ...
  medical: {
    ...
    blocks: [
      ...
      },
      {
        id: 'm-dest',
        title: 'Hospital Load',
        subtitle: 'Destination distribution',
        colSpan: 1,
        rowSpan: 1,
        type: 'bar',
      },
      ...
      {
        id: 'm-calendar',
        title: 'Annual EMS Log',
        subtitle: 'Daily calls',
        colSpan: 3,
        rowSpan: 1,
        type: 'calendar',
      },
  ...
  infrastructure: {
    ...
    blocks: [
      ...
      {
        id: 'i-calendar',
        title: 'Annual Infrastructure Log',
        subtitle: 'Daily issues',
        colSpan: 3,
        rowSpan: 1,
        type: 'calendar',
      },
  ...
  weather: {
    ...
    blocks: [
      ...
      {
        id: 'wx-calendar',
        title: 'Annual Weather Log',
        subtitle: 'Daily conditions',
        colSpan: 3,
        rowSpan: 1,
        type: 'calendar',
      },
