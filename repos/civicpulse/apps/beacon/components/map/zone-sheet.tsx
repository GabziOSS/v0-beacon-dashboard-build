          ...
          <div className="p-4 space-y-4">
              ...
              {[
                {
                  ...
                  color: zone.activeIncidents > 0 ? 'text-destructive' : 'text-success',
                },
                {
                  label: 'Risk Score',
                  value:
                ...
                <div key={kpi.label} className="bg-card-nested border border-border rounded-sm p-3">
                  ...
                  <p
                    className={cn(
                      'text-2xl font-semibold font-mono tabular-nums leading-tight mt-1',
                      kpi.color
                    )}
                  >
                    {kpi.value}
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className={cn('text-[10px] font-mono font-semibold', RISK_TEXT[zone.risk])}>
                  {zone.risk}
                </span>
              </div>
              <div className="space-y-1.5">
                {[
                  {
                    label: 'Fire',
                    val: zone.risk === 'Critical' ? 88 : zone.risk === 'High' ? 65 : 30,
                  },
                  {
                    label: 'Flood',
                    val: zone.risk === 'Critical' ? 75 : zone.risk === 'High' ? 80 : 20,
                  },
                  {
                    label: 'Crime',
                    val: zone.risk === 'Critical' ? 60 : zone.risk === 'High' ? 55 : 35,
                  },
                  {
                    label: 'Medical',
                    val: zone.risk === 'Critical' ? 70 : zone.risk === 'High' ? 50 : 45,
                  },
                ].map(bar => (
            ...
            <div className="space-y-1.5">
              ...
              {[
                ...
                <div
                  key={row.label}
                  className="flex justify-between items-center border-b border-border pb-1.5 text-xs"
                >
          ...
          <div className="p-4 space-y-2">
            {zoneIncidents.length === 0 ? (
              ...
              zoneIncidents.map(inc => (
                <div
                  key={inc.id}
                  className="bg-card-nested border border-border rounded-sm p-3 space-y-2"
                >
