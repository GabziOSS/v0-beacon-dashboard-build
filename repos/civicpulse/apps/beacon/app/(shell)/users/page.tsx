            ...
            <div className="space-y-2 text-xs text-muted-foreground">
              {user.role === 'admin' && (
                <>
                  ...
                  <div className="flex items-center gap-2">
                    <Shield className="w-3.5 h-3.5" /> Settings configuration
                  </div>
                </>
              )}
              {user.role === 'analyst' && (
                <>
                  ...
                  <div className="flex items-center gap-2">
                    <Shield className="w-3.5 h-3.5" /> Create reports
                  </div>
                  <div className="flex items-center gap-2">
                    <Shield className="w-3.5 h-3.5" /> Export data
                  </div>
                </>
              )}
              {user.role === 'responder' && (
                <>
                  ...
                  <div className="flex items-center gap-2">
                    <Shield className="w-3.5 h-3.5" /> Update incident status
                  </div>
                  <div className="flex items-center gap-2">
                    <Shield className="w-3.5 h-3.5" /> Submit reports
                  </div>
                </>
              )}
              {user.role === 'viewer' && (
                <>
                  ...
                  <div className="flex items-center gap-2">
                    <Shield className="w-3.5 h-3.5" /> View public dashboards
                  </div>
                </>
              )}
            </div>
