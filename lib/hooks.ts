...
export function useWindRose() {
  return useQuery<WindRoseData[]>(() => [
    { direction: "N",  low: 12, mid: 18, high:  8 },
    { direction: "NE", low: 20, mid: 32, high: 14 },
    { direction: "E",  low: 15, mid: 22, high:  9 },
    { direction: "SE", low: 28, mid: 40, high: 18 },
    { direction: "S",  low: 22, mid: 35, high: 16 },
    { direction: "SW", low: 10, mid: 14, high:  6 },
    { direction: "W",  low:  8, mid: 12, high:  5 },
    { direction: "NW", low: 16, mid: 24, high: 11 },
  ])
}
  ...
  return useQuery<Incident[]>(() => [
    {
      ...
      coordinates: [12.0730, 124.0070],
      timestamp: "2025-03-08T06:32:00",
      responders: 12,
      duration: 47,
      description: "Commercial structure fire at Maharlika Highway, spreading to adjacent buildings.",
    ...
    },
    {
      ...
      coordinates: [12.0690, 124.0300],
      timestamp: "2025-03-08T03:30:00",
      responders: 6,
      duration: 225,
      description: "Power line down across main road. Traffic rerouted, LEYTE SAMAR AREA power advised.",
    ...
    },
    {
      ...
      coordinates: [12.0740, 124.0060],
      timestamp: "2025-03-08T02:00:00",
      responders: 20,
      duration: 360,
      description: "Typhoon Rosita making landfall. Category 4. Storm surge warning levels 1–4 active.",
    ...
    },
    {
      ...
      coordinates: [12.0620, 124.0260],
      timestamp: "2025-03-07T21:10:00",
      responders: 9,
      duration: 84,
      description: "Residential fire contained after approximately 90 minutes. Two structures damaged.",
